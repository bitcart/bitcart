...
def upgrade() -> None:
    ...
    op.execute(CreateSequence(SQLSequence("paymentmethods_id_seq")))  # TODO: when merging in one file, investigate
    op.add_column(
        "paymentmethods",
...
def downgrade() -> None:
    ...
    op.execute(DropSequence(SQLSequence("paymentmethods_id_seq")))
    # ### end Alembic commands ###
