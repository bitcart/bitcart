...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_productsxinvoices_product_id'), table_name='productsxinvoices')
    op.drop_index(op.f('ix_productsxinvoices_invoice_id'), table_name='productsxinvoices')
