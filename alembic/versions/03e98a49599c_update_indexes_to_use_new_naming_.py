...
revision = "03e98a49599c"
down_revision = "c0fb4e374830"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(
        op.f("discounts_currencies_idx"), "discounts", ["currencies"], unique=False
    )
    op.create_index(
        op.f("discounts_description_idx"), "discounts", ["description"], unique=False
    )
    ...
    op.create_index(
        op.f("invoices_store_id_idx"), "invoices", ["store_id"], unique=False
    )
    ...
    op.create_index(
        op.f("notifications_name_idx"), "notifications", ["name"], unique=False
    )
    ...
    op.create_index(
        op.f("products_store_id_idx"), "products", ["store_id"], unique=False
    )
...
def downgrade():
    ...
    op.create_index(
        "ix_paymentmethods_currency", "paymentmethods", ["currency"], unique=False
    )
    ...
    op.create_index(
        "ix_discounts_description", "discounts", ["description"], unique=False
    )
    op.create_index(
        "ix_discounts_currencies", "discounts", ["currencies"], unique=False
    )
