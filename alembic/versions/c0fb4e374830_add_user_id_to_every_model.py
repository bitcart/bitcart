...
def upgrade():
    ...
    op.create_foreign_key(
        op.f("invoices_user_id_users_fkey"), "invoices", "users", ["user_id"], ["id"], ondelete="SET NULL",
    )
    op.add_column("products", sa.Column("user_id", sa.Integer(), nullable=True))
    op.create_foreign_key(
        op.f("products_user_id_users_fkey"), "products", "users", ["user_id"], ["id"], ondelete="SET NULL",
    )
    op.add_column("stores", sa.Column("user_id", sa.Integer(), nullable=True))
    op.create_foreign_key(
        op.f("stores_user_id_users_fkey"), "stores", "users", ["user_id"], ["id"], ondelete="SET NULL",
    )
