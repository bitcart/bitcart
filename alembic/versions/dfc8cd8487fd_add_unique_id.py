...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    print("Note: Downgrading unsupported")
    op.alter_column("walletsxstores", "wallet_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("walletsxstores", "store_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("wallets", "user_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column(
        "wallets",
        "id",
    ...
    op.alter_column("templates", "user_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("templates", "id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=False)
    op.alter_column("stores", "user_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column(
        "stores",
        "id",
        existing_type=sa.String(),
    ...
    op.alter_column("settings", "id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=False)
    op.alter_column("productsxinvoices", "product_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("productsxinvoices", "invoice_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("products", "user_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("products", "store_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column(
        "products",
        "id",
        existing_type=sa.String(),
    ...
    op.alter_column("paymentmethods", "invoice_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column(
        "paymentmethods",
        "id",
        existing_type=sa.String(),
    ...
    op.alter_column("notificationsxstores", "store_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column(
        "notificationsxstores", "notification_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True
    )
    op.alter_column("notifications", "user_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column(
        "notifications",
        "id",
        existing_type=sa.String(),
    ...
    op.alter_column("invoices", "user_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("invoices", "store_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column(
        "invoices",
        "id",
        existing_type=sa.String(),
    ...
    op.alter_column("discountsxproducts", "product_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("discountsxproducts", "discount_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("discounts", "user_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    op.alter_column("discounts", "id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=False)
    op.alter_column("tokens", "user_id", existing_type=sa.String(), type_=sa.INTEGER(), existing_nullable=True)
    # ### end Alembic commands ###
