...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "stores", sa.Column("template", sa.VARCHAR(length=1000), autoincrement=False, nullable=True),
    )
    op.add_column(
        "stores", sa.Column("domain", sa.VARCHAR(length=1000), autoincrement=False, nullable=True),
    )
